...
%Used previously but not since 1/14/25 update that fixed ES&T results
...
ef = [59367, 1.060, 0.75, 2.54, 22.21, 36.4, 3.507, 3.507, 0.26857]; % assuming large utility boiler for 5000-acre facility
direct_cap = (annual_NG*47.1/1055)*ef/1000; % annual NG in kg per yr*kg NG to MJ*MJ to mmBTU*EF(g/mmBTU)*(1kg/1000g)
fossil_co2 = direct_cap(1); %fossil CO2 is CO2 portion of NG boiler emissions
biogenic_c_in_gas_phase = (direct_co2 - fossil_co2); % biogenic CO2 in kg CO2/yr

% carbon from aqueous phase
c_aq_dist = .336 - lip*.422; %from Leow et al., carbon % in aqueous phase as function of total carbon in feedstock based on linear function
