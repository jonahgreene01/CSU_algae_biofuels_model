function [net_process_lca, stage_breakdwn,stage_breakdwn_prc,consum_breakdwn, consum_breakdwn_prc,aware_outputs, traci_vec, nerc_out, bC_balance, elec_partition] = LCA_SAF_HM_v3(co2_capt_lci, cult_out,storage_fcn_out,SAF_LCA_consum,coord,file_id, aware_cult, transp_vec, op_hours, grid_red)
...
saf_outputs =  str2double(SAF_LCA_consum(:,2));
