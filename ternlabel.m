...
r(2) = text(1.08-0.45*sin(deg2rad(30)), 0.5, B, 'rotation', -60, 'horizontalalignment', 'center');
r(3) = text(0.45*sin(deg2rad(30)) - 0.08, 0.5, C, 'rotation', 60, 'horizontalalignment', 'center');
